...
const randomInt = bits => random(0, Math.exp(2, bits) - 1);

console.log(Math.exp(2, 16) - 1);
...
optionTest('brainSwapHeight', 'ChangeAcksHeight', {
  brainSwapHeight: randomInt(16)
});
argTest('faultTimeoutInSeconds', 'faulttimeout', {
  faultTimeoutInSeconds: 12345
});
//# sourceMappingURL=/Users/jay/code/factomd-docker/node_modules/.cache/ava/dee0954ed1f403657debe51db8d1e3cf.js.map