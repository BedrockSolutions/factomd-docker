...
const getArgs = async config => {
  ...
  const args = matchAll(startupScript, /-([a-z]+)=("?[^ \"]+"?)/g).toArray();
  console.log(args);
};
...
//# sourceMappingURL=/Users/jay/code/factomd-docker/node_modules/.cache/ava/cc5d6165943516aef87dd982602d3ca7.js.map