...
const generateHexId = () => times(() => random(0, 15).toString(16), 64).join('');
...
optionText('authorityServerPrivateKey', 'LocalServerPrivKey', {
  authorityServerPrivateKey: generateHexId()
});
argTest('faultTimeoutInSeconds', 'faulttimeout', {
  faultTimeoutInSeconds: 123
}, '123');
//# sourceMappingURL=/Users/jay/code/factomd-docker/node_modules/.cache/ava/6d5729cfde78b130ae829aed48dd748b.js.map